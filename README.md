...
- Streamlit: [`STREAMLIT_DEMO_LINKINI_BURAYA_EKLE`](https://irrs8jkrjx2awizgo7lzgo.streamlit.app/)
- GitHub: [`GITHUB_REPO_LINKINI_BURAYA_EKLE`](https://github.com/afes53/Demand-Planning)
